...
/**
 * Controller for DailyDonation. This class supports the following operations:
 *
 * <OL>
 *   <LI>Create a DailyDonation.
 *   <LI>Update a DailyDonation with different quality of items.
 *   <LI>Cancel a DailyDonation in case the Food Donor cannot donate anything.
 *   <LI>Commit a DailyDonation to a food donor by connecting to a DailyNeed.
 *   <LI>Withdraw a DailyDonation to a food donor by connecting to a DailyNeed.
 * </OL>
 *
 * Notice, volunteer signup is implemented in VolunteerController.
 */
@RestController
@RequestMapping(
...
@Transactional
public class DailyDonationController extends CrudController<DailyDonation> {
  private static final Logger LOG = LoggerFactory.getLogger(DailyDonationController.class);
  ...
  @Autowired
  public DailyDonationController(
